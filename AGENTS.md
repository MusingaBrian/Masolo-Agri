...
- Inspect git status and recent git history.
...
- Record unfinished work and blockers.
- Record important decisions.
- Record the exact recommended next steps.
- Do not claim work is complete unless it was actually implemented and verified.
